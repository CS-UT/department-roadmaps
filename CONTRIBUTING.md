...
از علاقه شما به مشارکت در این پروژه ممنونیم! هدف ما این است که نقشه راه تمام رشته‌های دانشکده ریاضی، آمار و علوم کامپیوتر دانشگاه تهران را پوشش دهیم.

## افزودن نقشه راه رشته جدید

افزودن رشته جدید **نیاز به تغییر کد ندارد** — فقط کافی است یک فایل YAML بسازید.
